...
#
# bsub -n 10 -W 23:59 -R ib sh R --vanilla --slave -f ../../DetectShifts_t5_SCALAROU_best_clade_2.R --args 96
#
...
prefixFiles = paste0("SCALAROU_best_clade_2_id_", id)
...
fitMappings <- PCMFitMixed(
  ...
  values, tree, modelTypes = MGPMScalarOUType(),
