...
#
# bsub -M 200000 -n 200 -W 23:59 -R ib sh R --vanilla --slave -f ../../DetectShifts_t5_MGPM_A_F_all.R --args 96
#
...
fitMappings <- PCMFitMixed(
  ...
  maxCladePartitionLevel = 1L, maxNumNodesPerCladePartition = Inf,
