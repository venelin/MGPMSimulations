...
#
# bsub -M 200000 -n 200 -W 23:59 -R ib sh R --vanilla --slave -f ../../DetectShifts_t4_MGPM_SURFACE_all.R --args 96
#
...
prefixFiles = paste0("MGPM_SURFACE_t4_id_", id, "_all_1_")
...
tree <- testData_t4$tree[[id]]
values <- testData_t4$X[[id]][, 1:PCMTreeNumTips(tree)]
...
fitMappings <- PCMFitMixed(
  ...
  argsMixedGaussian = Args_MixedGaussian_MPGMSurfaceOUType(),
